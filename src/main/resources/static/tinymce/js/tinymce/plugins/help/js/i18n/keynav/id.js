...
'<h1>Memulai navigasi keyboard</h1>\n' +
  ...
  '  <li>Bilah sisi</li>\n' +
  '  <li>Alur elemen di footer.html</li>\n' +
  '  <li>Tombol aktifkan/nonaktifkan jumlah kata di footer.html</li>\n' +
  '  <li>Tautan merek di footer.html</li>\n' +
  '  <li>Pengatur pengubahan ukuran editor di footer.html</li>\n' +
  '</ol>\n' +
  '\n' +
  '<p>Jika suatu bagian UI tidak ada, bagian tersebut dilewati.</p>\n' +
  '\n' +
  '<p>Jika fokus navigasi keyboard ada pada footer.html, tetapi tidak ada bilah sisi yang terlihat, menekan <strong>Shift+Tab</strong>\n' +
  ...
  '  <li>berpindah-pindah antar-item di dalam alur elemen footer.html.</li>\n' +
  '</ul>\n' +
  '\n' +
